# -*- coding: utf-8 -*-
#
# graphene-elastic documentation build configuration file, created
# by sphinx-quickstart on Tue Nov 22 09:31:14 2019.
#
...
sys.path.insert(0, os.path.abspath(os.path.join('..', 'examples', 'apps')))
...
htmlhelp_basename = 'graphene-elasticdoc'
...
latex_documents = [
  ('index',
   'graphene-elastic.tex',
   u'graphene-elastic Documentation',
