...
__title__ = "graphene_elastic.filter_backends.filtering.mixins.nested"
__author__ = "Stephen Ling <lingfromsh@163.com>"
__copyright__ = "2021-2021 Artur Barseghyan"
...
class NestedFilteringFilterMixin(object):
    ...
    def apply_filter_term(cls, queryset, options, value):
        ...
        return cls.apply_filter(
            ...
            kwargs={
                "path": options["path"],
                "query": Bool(filter=Q("term", **{options["field"]: value})),
            },
        )
    ...
    def apply_filter_terms(cls, queryset, options, value):
        ...
        return cls.apply_filter(
            ...
            kwargs={
                "path": options["path"],
                "query": Bool(
                    filter=Q("terms", **{options["field"]: __values})
                ),
            },
        )
    ...
    def apply_query_exists(cls, queryset, options, value):
        ...
        if _value_lower in TRUE_VALUES:
            return cls.apply_query(
                ...
                kwargs={
                    "path": options["path"],
                    "query": Bool(filter=Q("exists", field=options["field"])),
                },
            )
    ...
    def apply_filter_prefix(cls, queryset, options, value):
        ...
        return cls.apply_filter(
            ...
            kwargs={
                "path": options["path"],
                "query": Bool(filter=Q("prefix", **{options["field"]: value})),
            },
        )
    ...
    def apply_query_wildcard(cls, queryset, options, value):
        ...
        return cls.apply_query(
            ...
            kwargs={
                "path": options["path"],
                "query": Q("wildcard", **{options["field"]: value}),
            },
        )
    ...
    def apply_query_contains(cls, queryset, options, value):
        ...
        return cls.apply_query(
            ...
            kwargs={
                "path": options["path"],
                "query": Q(
                    "wildcard", **{options["field"]: "*{}*".format(value)}
                ),
            },
        )
    ...
    def apply_query_in(cls, queryset, options, value):
        ...
        if _queries:
            queryset = cls.apply_query(
                ...
                kwargs={
                    "path": options["path"],
                    "query": six.moves.reduce(operator.or_, _queries),
                },
            )
    ...
    def apply_query_exclude(cls, queryset, options, value):
        ...
        if __queries:
            queryset = cls.apply_query(
                ...
                kwargs={
                    "path": options["path"],
                    "query": six.moves.reduce(operator.and_, __queries),
                },
            )
