...
__all__ = ("SuggestFilterBackend",)


class SuggestFilterBackend(BaseBackend, FilteringFilterMixin):
    ...
    def get_backend_query_fields(self,
        ...
        return super(SuggestFilterBackend, self).get_backend_query_fields(
            items=items,
